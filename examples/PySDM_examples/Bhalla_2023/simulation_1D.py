...
class Simulation:
    ...
    def get_plt_name(self, plot_var: str)->str:
        return f"1D {plot_var} v_t-{self.builder.get_attribute('terminal velocity').approximation.__class__.__name__} n_sd_per_gridbox-{self.settings.n_sd_per_gridbox}"
