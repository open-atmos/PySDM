...
class Settings:
    def __init__(
       ...
       # print( n_sd, w_updraft, T0, N_solution_droplet, r_mean )
        ...
        dry_air_density = formulae.trivia.p_d(self.p0, self.initial_water_vapour_mixing_ratio) / formulae.constants.Rd / self.T0


        
        # N_solution_droplet = 1e4 / si.centimetre**3
        spectrum = Lognormal(norm_factor=N_solution_droplet/dry_air_density, m_mode=r_mean, s_geom=1.6)
        ...
        self.t_duration = 3600. #60. #5400 # total duration of simulation
        self.dt         = 1. 
