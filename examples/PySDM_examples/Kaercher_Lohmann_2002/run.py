...
def plot(output, setting, pp):
    ...
    axTz.plot(time, z, color="black", linestyle="-", label="dz", linewidth=5)
    axTz.set_ylabel("vertical displacemet [m]")
    axTz.set_ylim(-5, 1000)
    twin = axTz.twinx()
    twin.plot(time, temperature, color="red", linestyle="-", label="T", linewidth=5)
    ...
    axRH.plot(time, rh, color="blue", linestyle="-", label="water", linewidth=5)
    axRH.plot(time, rhi, color="red", linestyle="-", label="ice", linewidth=5)
    axRH.plot(time, rhi_crit, color="black", linestyle="-", label="crit", linewidth=5)
    axRH.legend()
    ...
    axWC.plot(time, twc, color="black", linestyle="--", label="total", linewidth=5)
    axWC.plot(time, lwc, color="blue", linestyle="-", label="water", linewidth=5)
    axWC.plot(time, iwc, color="red", linestyle="-", label="ice", linewidth=5)
    # axWC.set_yscale('log')
    axWC.legend()
    ...
    axN.plot(time, ns, color="blue", linestyle="-", label="droplet", linewidth=5)
    axN.plot(time, ni, color="red", linestyle="-", label="ice", linewidth=5)
    ...
    axR.plot(time, rs, color="blue", linestyle="-", label="droplet", linewidth=5)
    axR.plot(time, ri, color="red", linestyle="-", label="ice", linewidth=5)
