...
of [Kessler 1969 (section 3C)](https://doi.org/10.1007/978-1-935704-36-2_1).
...
It was introduced in [Morrison & Grabowski 2007](https://doi.org/10.1175/JAS3980)
and later adopted for particle-based simulations in [Arabas et al. 2015](https://doi.org/10.5194/gmd-8-1677-2015)
...
It can be found also in [Szumowski et al. 1998 (Atmos. Res.)](https://doi.org/10.1016/S0169-8095(97)00082-3)
"""
