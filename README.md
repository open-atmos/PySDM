...
particulator = builder.build(attributes, py.list({ ...
    ...
    products.CloudDropletEffectiveRadius(pyargs('name', 'r_eff', 'unit', 'um', radius_range', cloud_range)), ...
    products.CloudDropletConcentration(pyargs('name', 'n_c_cm3', 'unit', 'cm^-3', radius_range', cloud_range)), ...
