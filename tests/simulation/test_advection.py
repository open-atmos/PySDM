...
class TestAdvection:
    ...
    def test_single_cell(self):
        ...
        state = State.state_2d(n=n, intensive={}, extensive={}, positions=positions, backend=Default)
    ...
    def test_advection(self):
        ...
        state = State.state_2d(n=n, intensive={}, extensive={}, backend=Default, positions=positions)
        sut = Advection(n_sd=n_sd, courant_field=courant_field, backend=Default)
