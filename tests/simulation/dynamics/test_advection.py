...
from SDM.simulation.dynamics.advection import ExplicitEulerWithInterpolation
...
class TestExplicitEulerWithInterpolation:
    ...
    def test_single_cell(self):
        ...
        sut = ExplicitEulerWithInterpolation(n_sd=n_sd, courant_field=courant_field, backend=Default)
    ...
    def test_update_position(self):
        ...
        sut = ExplicitEulerWithInterpolation(n_sd=n_sd, courant_field=dummy_courant_field, backend=Default)
