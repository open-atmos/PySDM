...
def test_mixed_phase_moments(particle_volume):
    ...
    builder = Builder(
        ...
        environment=Parcel(
            ...
            T0=265 * si.kelvin,
            initial_water_vapour_mixing_ratio=0.0,
            w=0.0,
            mixed_phase=True,
        ),
        backend=CPU(
    ...
    products = [
        ...
        PySDM_products.ParticleConcentration(name="n_water", radius_range=(0, np.inf)),
        PySDM_products.ParticleConcentration(name="n_ice", radius_range=(-np.inf, 0)),
