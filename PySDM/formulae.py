...
class Formulae:  # pylint: disable=too-few-public-methods,too-many-instance-attributes,too-many-statements
    def __init__(  # pylint: disable=too-many-locals,too-many-arguments
        ...
        *,
        ...
        collision_kernel_liquid_liquid: str = "Neglect",
        collision_kernel_liquid_ice: str = "Neglect",
        collision_kernel_ice_ice: str = "Neglect",
        ...
        self.collision_kernel_liquid_liquid = collision_kernel_liquid_liquid
        self.collision_kernel_liquid_ice = collision_kernel_liquid_ice
        self.collision_kernel_ice_ice = collision_kernel_ice_ice
