...
class StorageMethods:
    ...
    @staticmethod
    @numba.njit(void(int64[:], int64, float64[:]), parallel=conf.NUMBA_PARALLEL, fastmath=conf.NUMBA_FASTMATH)
    ...
    @staticmethod
    @numba.njit(void(int64[:], int64, float64[:], int64[:]), parallel=True, fastmath=conf.NUMBA_FASTMATH)
