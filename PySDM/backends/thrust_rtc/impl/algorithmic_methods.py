...
class AlgorithmicMethods(Methods):
    ...
    __adaptive_sdm_gamma_body_1 = trtc.For(
    ...
    __adaptive_sdm_gamma_body_2 = trtc.For(
    ...
    __adaptive_sdm_gamma_body_3 = trtc.For(
    ...
    __adaptive_sdm_gamma_body_4 = trtc.For(
    ...
    @staticmethod
    @nice_thrust(**NICE_THRUST_FLAGS)
    def adaptive_sdm_gamma(gamma, n, cell_id, dt_left, dt, dt_range,
        ...
        AlgorithmicMethods.__adaptive_sdm_gamma_body_1.launch_n(
        ...
        AlgorithmicMethods.__adaptive_sdm_gamma_body_4.launch_n(
            len(dt_left),
    ...
    def cell_id(cell_id, cell_origin, strides):
        ...
        AlgorithmicMethods.__cell_id_body.launch_n(
            len(cell_id),
    ...
    def interpolation(output, radius, factor, b, c):
        ...
        AlgorithmicMethods.__interpolation_body.launch_n(
            len(radius),
    ...
    ___sort_by_cell_id_and_update_cell_start_body = trtc.For(
