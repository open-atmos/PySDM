...
class MomentsMethods:
    ...
    def moments(moment_0, moments, n, attr_data, cell_id, idx, length, ranks,
        ...
        MomentsMethods.__loop_reset.launch_n(moment_0.shape[0], [moment_0.data])
        MomentsMethods.__loop_reset.launch_n(reduce(lambda x, y: x * y, moments.shape), [moments.data])

        MomentsMethods.__moments_body_0.launch_n(length,
                                                     [idx.data,
        ...
        MomentsMethods.__moments_body_1.launch_n(
