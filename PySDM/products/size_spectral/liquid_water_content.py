"""
liquid water content products (mixing ratio and density)
"""
...
class LiquidWaterContent(MomentProduct):
    ...
    def _impl(self, **kwargs):
        ...
        result[:] *= conc / self.particulator.mesh.dv
...
class SpecificLiquidWaterContent(LiquidWaterContent):
