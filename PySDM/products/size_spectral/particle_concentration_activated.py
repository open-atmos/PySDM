...
class ActivatedParticleConcentration(ConcentrationProduct,_ActivationFilteredProduct):
    ...
    def __init__(
        ...
        *,
        ...
        ConcentrationProduct.__init__(self,name=name, unit=unit, specific=specific, stp=stp)
        _ActivationFilteredProduct.__init__(self,count_activated=count_activated,count_unactivated=count_unactivated)
...
class ActivatedParticleSpecificConcentration(ActivatedParticleConcentration):
    def __init__(self, count_unactivated, count_activated, name=None, unit="kg^-1"):
        super().__init__(count_unactivated=count_unactivated,count_activated=count_activated, specific=True, name=name, unit=unit)
