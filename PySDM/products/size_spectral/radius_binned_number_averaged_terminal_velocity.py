...
class RadiusBinnedNumberAveragedTerminalVelocity(SpectrumMomentProduct):
    ...
    def register(self, builder):
        ...
        volume_bin_edges = builder.particulator.formulae.trivia.volume(self.radius_bin_edges)
        self.attr_bins_edges = builder.particulator.backend.Storage.from_ndarray(volume_bin_edges)
