...
class PairBackend(backend.PairBackend):
    ...
    def distance_pair(data_out, data_in, is_first_in_pair, idx):
        return PairBackend.distance_pair_body(
            data_out.data,
            data_in.data,
    ...
    def find_pairs(cell_start, is_first_in_pair, cell_id, cell_idx, idx):
        return PairBackend.find_pairs_body(
    ...
    def max_pair(data_out, data_in, is_first_in_pair, idx):
        return PairBackend.max_pair_body(
            data_out.data,
            data_in.data,
            is_first_in_pair.indicator.data,
            idx.data,
    ...
    def min_pair(data_out, data_in, is_first_in_pair, idx):
        return PairBackend.min_pair_body(
            data_out.data,
            data_in.data,
            is_first_in_pair.indicator.data,
            idx.data,
    ...
    def sort_pair(data_out, data_in, is_first_in_pair, idx):
        return PairBackend.sort_pair_body(
            data_out.data,
            data_in.data,
            is_first_in_pair.indicator.data,
            idx.data,
    ...
    def sort_within_pair_by_attr(idx, is_first_in_pair, attr):
        PairBackend.sort_within_pair_by_attr_body(
    ...
    def sum_pair(data_out, data_in, is_first_in_pair, idx):
        return PairBackend.sum_pair_body(
            data_out.data,
            data_in.data,
            is_first_in_pair.indicator.data,
            idx.data,
    ...
    def multiply_pair(data_out, data_in, is_first_in_pair, idx):
        return PairBackend.multiply_pair_body(
            data_out.data,
            data_in.data,
            is_first_in_pair.indicator.data,
            idx.data,
